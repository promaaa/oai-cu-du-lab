...
|---|---|---|---|---|
| `cu-du/patches/oai-pws-sib8-cu-du.patch` | `patches/sib8/` | SIB8/PWS feature patch candidate | Yes, verify no secrets or generated blobs | Not migrated |
...
| `cu-du/conf/*.yml` | `conf/templates/` | Baseline config template source | Yes, remove identifiers and generated/runtime values | Not migrated |
...
| `cu-du-backhauling/scripts/setup-gre-policy-routing.sh` | `scripts/` | Wi-Fi GRE backhaul setup/rollback pattern | Yes, parameterize IPs and remove credentials | Not migrated |
...
| `cu-du-backhauling/conf/*.yml` | `conf/templates/` | Wi-Fi and Ethernet split templates | Yes, sanitize identifiers and runtime values | Not migrated |
...
| `cu-du-5g-backhauling/scripts/quectel-backhaul/` | `scripts/quectel-backhaul/` | Quectel detection, WireGuard, validation, rollback candidates | Yes, remove passwords, private key material, identifiers, and generated configs | Not migrated |
| `cu-du-5g-backhauling/docs/quectel-f1-backhaul.md` | `docs/ROADMAP.md` or future experiment report | Quectel partial evidence and circular-dependency analysis | Yes, redact IMSI/ICCID/password notes | Not migrated |
...
| `kaust-5g-research/docs/Presentation/Research Progress Report 5.md` | `patches/rpi-du/` planning docs | Raspberry Pi 5 DU migration context | Yes, verify no credentials | Not migrated |
