...
| `cu-du-5g-backhauling/scripts/quectel-backhaul/` | `scripts/quectel-f1-backhaul/` (canonical), `conf/quectel-f1-backhaul/` | Quectel detection, WireGuard, validation, rollback, OAI config generation | Yes, SSH/password/key assumptions removed; local-only key generation enforced; security guardrails added | **Migrated** (clean rewrite, no secrets) |
| `cu-du-5g-backhauling/docs/quectel-f1-backhaul.md` | `docs/quectel-f1-backhaul/` (all 6 phase docs), `conf/templates/quectel-wireguard.yml` | Quectel partial evidence and circular-dependency analysis | Yes, identifiers/password notes omitted | **Migrated** (distilled into canonical phase docs) |
