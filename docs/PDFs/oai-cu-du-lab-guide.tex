...
account of unfinished work. The Research Progress Reports and the maintained
operator matrix record successful demonstrations of the following
capabilities:
...
\section{Research report provenance}

This tutorial reconciles the historical validation record rather than using a
single latest hardware arrangement as the whole project status.

\begin{longtable}{@{}L{23mm}L{134mm}@{}}
\toprule
Report & Main evidence used in this guide \\
\midrule
\endfirsthead
\toprule
Report & Main evidence used in this guide \\
\midrule
\endhead
4--5 & B210 validation, early MiniPC split, and Raspberry Pi bandwidth exploration \\
6 & Monolithic core, B210, commercial UE registration, and initial PWS setup \\
7--9 & Operational F1, PWS implementation, phone internet, and working RF profile \\
10 & Wi-Fi GRE F1, OAI nrUE public internet, and phone-visible split PWS \\
11--14 & Quectel registration, QMI, WireGuard, working wireless F1, Pi cutover, and TUI gates \\
17--18 & Single-B210 limitation, Ethernet MCS unlock, BLER analysis, and MSS tuning \\
19--20 & X310 transport exploration, Jetson integration, phone service, and cross-host throughput table \\
21 & Power and payload planning context, separate from network functionality \\
22 & Jetson Quectel throughput recovery, DL\_MAX\_MCS=28 tuning, and budget drone sizing \\
\bottomrule
\end{longtable}

The reports are stored in the companion research repository under
\texttt{docs/Presentation/}, with filenames of the form
\texttt{Research Progress Report N.md}. They contain historical addresses and
intermediate interpretations. This guide keeps the reusable procedure and
successful functional boundary.
