...
values, and safe log fingerprints.  Runtime inputs, raw logs/captures,
credentials, database identifiers, and keys are excluded.  Publication checks
cover Git history and the current tree.
...
endpoints during active traffic.  The artifact retains all 200 DL observations (20 per final
...
half-widths.  The artifact retains all 200 observations.}
...
Sanitized resource records in the artifact~\cite{artifactrepo} add host-level
evidence.  A 51-PRB Raspberry Pi 5 sample recorded load 2.04, 1.5 GiB used,
